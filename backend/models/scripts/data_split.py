...
#MOVE TO MAIN TO USE
# find_large_images('data_/nebulae_vs_galaxies/DSO_images')

def split_data(main_dir, training_dir, validation_dir, test_dir=None, include_test_split=True, split_size=0.9):
    """
    Splits the data_ into train validation and test sets (optional)
    ...
    shuffled_files = random.sample(files, len(files))  # shuffles the data_
