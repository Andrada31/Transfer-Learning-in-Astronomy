...
nebula_dir = 'data_/nebulae_vs_galaxies/DSO_images/Nebula'
galaxy_dir = 'data_/nebulae_vs_galaxies/DSO_images/Galaxy'

training_dir = 'data_/nebulae_vs_galaxies/training'
validation_dir = 'data_/nebulae_vs_galaxies/validation'
test_dir = 'data_/nebulae_vs_galaxies/test'
...
#CREATED IMAGE DATA GENERATORS with data_ augmentation for training
...
# find_large_images('data_/nebulae_vs_galaxies/test')

#RESIZE the image fize if large images are found
# resize_images_in_folder('data_/nebulae_vs_galaxies', max_size=500)
